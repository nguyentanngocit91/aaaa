class DanhSachBlacklistModel {
  ...
  DanhSachBlacklistModel.fromJson(dynamic json) {
    ...
    lichsuKhoitao = json['lichsu_khoitao']!=null? LichsuKhoitao.fromJson(json['lichsu_khoitao']) : null;
    lichsuCapnhat = (json['lichsu_capnhat'] as List).isNotEmpty ? LichsuCapnhat.fromJson(json['lichsu_capnhat']) : null;
  }
  String? id;
  String? sohopdong;
  String? ghichu;
...
DanhSachBlacklistModel copyWith({  String? id,
  String? sohopdong,
  String? ghichu,
  dynamic info,
  num? trangthai,
  LichsuKhoitao? lichsuKhoitao,
  LichsuCapnhat? lichsuCapnhat,
}) => DanhSachBlacklistModel(  id: id ?? this.id,
...
class LichsuCapnhat {
  ...
  String? hoten;
  String? phongbanId;
LichsuCapnhat copyWith({  String? id,
  String? manhanvien,
  String? hoten,
  String? phongbanId,
}) => LichsuCapnhat(  id: id ?? this.id,
...
class LichsuKhoitao {
  ...
  String? hoten;
  String? phongbanId;
LichsuKhoitao copyWith({  String? id,
  String? manhanvien,
  String? hoten,
  String? phongbanId,
}) => LichsuKhoitao(  id: id ?? this.id,
  manhanvien: manhanvien ?? this.manhanvien,
  hoten: hoten ?? this.hoten,
  phongbanId: phongbanId ?? this.phongbanId,
);
