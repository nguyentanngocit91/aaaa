...
part 'inforesponse_model.freezed.dart';
part 'inforesponse_model.g.dart';
...
@freezed
class InfoResponseModel with _$InfoResponseModel {
  const factory InfoResponseModel({
    int? countActivated,
    int? countTrashed,
    int? total,
    int? limit,
    int? page,
    int? lastPage}) = _InfoResponseModel;
